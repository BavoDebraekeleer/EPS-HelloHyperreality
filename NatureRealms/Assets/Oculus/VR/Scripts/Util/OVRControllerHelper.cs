...
public class OVRControllerHelper : MonoBehaviour
{
	...
	// Added function by Bavo
	public void SwapQuest2Controllers()
	{
		// Swap vars using tuples
		(m_modelOculusTouchQuest2LeftController, m_modelOculusTouchQuest2RightController) 
			= (m_modelOculusTouchQuest2RightController, m_modelOculusTouchQuest2LeftController);
		Update();
	}
}
