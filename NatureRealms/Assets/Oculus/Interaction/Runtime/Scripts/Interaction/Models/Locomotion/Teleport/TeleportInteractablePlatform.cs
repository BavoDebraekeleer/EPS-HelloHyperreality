...
{
    public struct TeleportHitPlatform
    {
        ...
        public TeleportHitPlatform(Transform relativeTo, Vector3 position, Vector3 normal, float snapRadius = 0f)
        {
        ...
        public static readonly TeleportHitPlatform DEFAULT =
            new TeleportHitPlatform()
            {
                relativeTo = null,
    ...
    public class TeleportInteractablePlatform : Interactable<TeleportInteractor, TeleportInteractable>
    {
        [SerializeField]
        ...
        [Header("Target")] [SerializeField] [Tooltip("Retain relative position to the platform.")]
        private bool _retainRelativePosition = true;
        ...
        // The following function returns the position to which to teleport
        ...
        // EDIT
        public Pose TargetPose(Pose hitPose, GameObject currentPlatform, GameObject teleportToPlatform)
        {
            Pose targetPose = hitPose;

            if (_retainRelativePosition)
            {
                Vector3 calculatedPosition = new Vector3(0, 0, 0);
                // Calculate position relative to currentPlatform,
                // and calculate new position relative to teleportToPlatform.
                targetPose.position = calculatedPosition;
            }
